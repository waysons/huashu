...
const cloudupupDailyData = {
  ...
  ${idinshop}`,
  开发票: `因为这边是海外公司, 所以无法开大陆发票, 但这边可以给您开invoice, 如果您需要的话, 写下您的 (公司全称) 和 (收款邮箱) 以及 (支付截图), 这边记录一下, 24小时内给您开, 请您耐心等待~`,
...
const bananaTempData = {
  holidayOFF: `我们最近的优惠活动都写在这里，请复制下述域名到浏览器打开，然后登陆后即可看到活动内容。（因为qq或者微信无法直接打开网站域名，必须复制到浏览器才能打开）
  目前暂不支持优惠码了, 都是直接购买套餐使用即可
  官网: ${banana1}
  您可以选购一下。`,
};
const bananaDailyData = {
  官网下载: `官网链接-永久域名: ${banana1}
...
const shaoshupaiTempData = {
  holidayOFF: `少数派活动快捷回复`,
};
